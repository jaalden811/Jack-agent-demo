...
create table if not exists research_runs (
  ...
  openai_embeddings_used boolean not null default false,
  firecrawl_extraction_used boolean not null default false,
  contact_enrichment_used boolean not null default false,
...
create table if not exists accounts (
  ...
  cisco_capability_match text[] not null default '{}',
...
create table if not exists evidence (
  ...
  verification_level text not null default 'snippet_only',
  source_date text,
